...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(159, 59);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(159, 105);
			this->textBox2->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(167, 22);
			this->textBox2->TabIndex = 1;
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &loginAdministracion::textBox2_TextChanged);
			// 
			// label1
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(51, 154);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(204, 154);
			...
			this->ClientSize = System::Drawing::Size(367, 238);
