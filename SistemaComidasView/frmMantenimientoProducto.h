...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Size = System::Drawing::Size(71, 30);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(323, 399);
			this->button5->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(71, 30);
			...
			this->button6->Size = System::Drawing::Size(71, 30);
			...
			this->ClientSize = System::Drawing::Size(1408, 494);
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	ProductoController^ objProductoController = gcnew ProductoController();
	List<Producto^>^ listaProductos = objProductoController->buscarAll();
	mostrarGrilla(listaProductos);
}
