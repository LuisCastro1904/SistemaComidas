...
namespace SistemaComidasView {
	...
	/// <summary>
	/// Resumen de ReporteDetallePedido
	/// </summary>
	public ref class ReporteDetallePedido : public System::Windows::Forms::Form
	{
	public:
		ReporteDetallePedido(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &ReporteDetallePedido::button1_Click);
			// 
			// ReporteDetallePedido
			// 
			...
			this->Name = L"ReporteDetallePedido";
			this->Text = L"Reporte de productos pedidos por dia";
			this->Load += gcnew System::EventHandler(this, &ReporteDetallePedido::ReporteDetallePedido_Load);
...
private: System::Void ReporteDetallePedido_Load(System::Object^ sender, System::EventArgs^ e) {
	String^ fechaSeleccionada = this->dateTimePicker1->Text;
	DetallePedidoController^ objDetallePedidoController = gcnew DetallePedidoController();
	List<String^>^ listaProductos = objDetallePedidoController->buscarDetallesPedidosxFecha(fechaSeleccionada);
	this->chart1->Series["Series1"]->Points->Clear();
